...
local plug_map = {
    ...
    ["n|<Leader>q"]             = map_cmd("<cmd>lua vim.lsp.diagnostic.set_loclist()<CR>"):with_noremap():with_silent(),
    ...
    ["n|<Leader>tt"]     = map_cu('Telescope git_files theme=ivy'):with_noremap():with_silent(),
    ["n|<Leader>rg"]     = map_cu('Telescope grep_string theme=ivy'):with_noremap():with_silent(),
    ["n|<Leader>rr"]     = map_cu('Telescope live_grep theme=ivy'):with_noremap():with_silent(),
