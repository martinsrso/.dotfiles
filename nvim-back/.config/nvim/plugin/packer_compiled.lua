...
_G.packer_plugins = {
  ...
  ["accelerated-jk"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/rafael.martins/.local/share/nvim/site/pack/packer/opt/accelerated-jk",
  ...
  ["nvim-jdtls"] = {
    loaded = true,
    path = "/Users/rafael.martins/.local/share/nvim/site/pack/packer/start/nvim-jdtls",
  ...
  ["nvim-toggleterm.lua"] = {
    ...
    loaded = true,
    path = "/Users/rafael.martins/.local/share/nvim/site/pack/packer/start/nvim-toggleterm.lua",
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-refactor", "nvim-treesitter-textobjects", "nvim-treesitter-textsubjects", "nvim-ts-context-commentstring" },
    loaded = true,
    only_config = true
  },
  ...
  ["vim-eft"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/rafael.martins/.local/share/nvim/site/pack/packer/opt/vim-eft",
  ...
  ["vim-test"] = {
    config = { "\27LJ\2\nm\0\0\3\0\4\0\t6\0\0\0009\0\1\0'\2\2\0B\0\2\0016\0\0\0009\0\1\0'\2\3\0B\0\2\1K\0\1\0\26set maxfuncdepth=1000(let test#java#runner = 'gradletest'\bcmd\bvim\0" },
    loaded = true,
    path = "/Users/rafael.martins/.local/share/nvim/site/pack/packer/start/vim-test",
...
try_loadstring("\27LJ\2\nm\0\0\3\0\4\0\t6\0\0\0009\0\1\0'\2\2\0B\0\2\0016\0\0\0009\0\1\0'\2\3\0B\0\2\1K\0\1\0\26set maxfuncdepth=1000(let test#java#runner = 'gradletest'\bcmd\bvim\0", "config", "vim-test")
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'surround.nvim', 'symbols-outline.nvim', 'kommentary', 'vim-eft'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'far.vim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
